...
<body>
    ...
    <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
            <h3 class="display-3 font-weight-bold text-white">Asignar Alumnos</h3>
    ...
    <div class="container my-5">
        <h2 class="text-center mb-4">Asignar Alumnos</h2>
    ...
    @include('footer')
    <!-- Back to Top -->
    <a href="{{ route('student') }}" class="btn btn-primary p-3 back-to-top"><i class="fa fa-angle-double-up"></i></a>
