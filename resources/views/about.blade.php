...
<head>
    <meta charset="utf-8">
    <title>CodeFlow - Conocenos</title>
...
<body>
    ...
    <!-- Back to Top -->
    <a href="{{ route('about') }}" class="btn btn-primary p-3 back-to-top"><i class="fa fa-angle-double-up"></i></a>
